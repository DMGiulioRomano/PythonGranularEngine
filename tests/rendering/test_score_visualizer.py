...
class TestEnvelopeColorsConfig:
    """La config del visualizer e' alimentata dalla palette dell'engine
    (ENVELOPE_COLORS vive in envelope_extractor, modulo matplotlib-free)."""
